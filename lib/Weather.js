...
module.exports = class Weather {
    ...
    displayForecastMessage(formattedData){
        const messageData = `In ${formattedData.name}, ${formattedData.state} the weather looks ${formattedData.type} with minimum ${formattedData.min} °C and maximum ${formattedData.max} °C`;
        return messageData;
    }
};
